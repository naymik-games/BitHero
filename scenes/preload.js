class preloadGame extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet("cards", "assets/sprites/spritesheet4.png", {
      frameWidth: 10,
      frameHeight: 10
    });
    this.load.spritesheet("border", "assets/sprites/border.png", {
      frameWidth: 16,
      frameHeight: 16
    });
    ...
    this.load.spritesheet("inventory", "assets/sprites/inventory.png", {
      frameWidth: 16,
      frameHeight: 16,
      margin: 1,
      spacing: 1
    ...
    this.load.image('top', 'assets/sprites/top.png');
